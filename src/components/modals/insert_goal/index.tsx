...
import { insertingIntoGoals } from '../../../service/goalService';
...
export default function InsertGoal(props: Props) {
      ...
      <Modal animationType="slide" transparent={true} visible={props.openModal}>
        <SafeAreaView style={style.containerMain}>
          ...
          <View style={style.containerBody}>
            <View>
              <Text style={style.fontMain}>Qual valor é seu objetivo final ?</Text>
            </View>
